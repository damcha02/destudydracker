...
(function () {
  ...
  var CONFIG = {
    ...
    forest: {
      dark:  { type: 'petals', color: '#a8d5a2', intensity: 0.85 },
      light: { type: 'petals', color: '#5d8f3c', intensity: 0.55 }
    },
    ocean: {
      dark:  { type: 'constellations', color: '#64d2ff', intensity: 1 },
      light: { type: 'constellations', color: '#168be0', intensity: 0.56 }
    },
    terminal: {
      dark:  { type: 'perlinflow', color: '#00ff41', intensity: 0.8 },
      light: { type: 'perlinflow', color: '#00a82b', intensity: 0.38 }
    },
    organs: {
      dark:  { type: 'rain', color: '#451616', intensity: 0.65 },
      light: { type: 'rain', color: '#b72a36', intensity: 0.28 }
    },
    ume: {
